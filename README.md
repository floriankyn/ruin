...
One repo — `git clone` then `docker compose up`.

| Directory | Contents |
|---|---|
| `web/` | TanStack Start — frontend + API routes |
| `python/` | Python OSINT + AI service |
| `infra/` | Config files (Keycloak, Prometheus, Nginx) |
